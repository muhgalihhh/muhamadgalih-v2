...
const staticProjects = [
  { id: "s1", title: "Full-Stack Web App",    category: "software" as const,      description: "End-to-end web application with real-time features, authentication, and a dashboard built with Next.js and Supabase.", color_class: "bg-violet", text_color_class: "text-cream", tech_stack: ["Next.js", "TypeScript", "Supabase", "Tailwind"], image_urls: [], emoji: "⚡", link: "/works", links: [], order_index: 0, project_date: null, published: true, created_at: "" },
  { id: "s2", title: "Brand Identity",        category: "uiux" as const,          description: "Complete brand identity design for an Indonesian startup.",                                                                color_class: "bg-coral",  text_color_class: "text-cream", tech_stack: ["Figma", "Illustrator"],                          image_urls: [], emoji: "🎨", link: "/works", links: [], order_index: 1, project_date: null, published: true, created_at: "" },
  { id: "s3", title: "Dashboard UI",          category: "uiux" as const,          description: "Data analytics dashboard with complex visualizations and dark mode support.",                                              color_class: "bg-sky",    text_color_class: "text-ink",   tech_stack: ["React", "Recharts", "Figma"],                    image_urls: [], emoji: "📊", link: "/works", links: [], order_index: 2, project_date: null, published: true, created_at: "" },
  { id: "s4", title: "Character Illustration",category: "illustration" as const,  description: "Original cartoon character series featuring 12 unique illustrated characters.",                                           color_class: "bg-yellow", text_color_class: "text-ink",   tech_stack: ["Procreate", "Illustrator", "Photoshop"],         image_urls: [], emoji: "✏️", link: "/works", links: [], order_index: 3, project_date: null, published: true, created_at: "" },
  { id: "s5", title: "Fintech Mobile App",    category: "uiux" as const,          description: "UI/UX design for a fintech mobile app with 40+ screens and an interactive prototype.",                                   color_class: "bg-mint",   text_color_class: "text-ink",   tech_stack: ["Figma", "ProtoPie"],                             image_urls: [], emoji: "📱", link: "/works", links: [], order_index: 4, project_date: null, published: true, created_at: "" },
  { id: "s6", title: "REST API Service",      category: "software" as const,      description: "Scalable REST API with auth, rate limiting, and auto-generated OpenAPI docs.",                                           color_class: "bg-pink",   text_color_class: "text-ink",   tech_stack: ["Node.js", "Express", "PostgreSQL", "Redis"],    image_urls: [], emoji: "🔧", link: "/works", links: [], order_index: 5, project_date: null, published: true, created_at: "" },
];
