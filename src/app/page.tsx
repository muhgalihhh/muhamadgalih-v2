...
import { getPublicProjects, getPublicSkills, getProfile, getPublicCategories } from "@/lib/data/portfolio";
import { getApprovedTestimonials, getOwnTestimonial } from "@/app/actions/testimonials";

export default async function Home() {
  const [projects, skills, profile, testimonials, ownTestimonial, categories] = await Promise.all([
    getPublicProjects(),
    getPublicSkills(),
    getProfile(),
  ...
  return (
    <main>
      ...
      <Works dbProjects={projects} categories={categories} />
